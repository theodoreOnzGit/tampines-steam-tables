...
use crate::app::local_widgets_and_buttons::hot_to_cold_colour_mark_2;

use super::hot_to_cold_colour_mark_1;

pub struct SinglePipeColourBlueRed {
    size: Vec2,
    vector: Vec2,
...
impl Widget for SinglePipeColourBlueRed {
...
pub struct SinglePipeColourBlackRed {
    size: Vec2,
    vector: Vec2,
    min_temp: ThermodynamicTemperature,
    max_temp: ThermodynamicTemperature,
...
impl Widget for SinglePipeColourBlackRed {
    fn ui(self, ui: &mut egui::Ui) -> egui::Response {
