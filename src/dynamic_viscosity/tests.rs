...
use crate::dynamic_viscosity::{psi_1_viscosity, mu_tp_eqm_single_phase, mu_tp_eqm_two_phase, mu_rho_t_eqm};
...
pub fn psi_1_viscosity_rho_t_test(){
    ...
    let eta_pa_s = mu_rho_t_eqm(t1, rho1)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_1,
        eta_pa_s,
    ...
    let eta_pa_s = mu_rho_t_eqm(t2,rho2)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_2,
        eta_pa_s,
    ...
    let eta_pa_s = mu_rho_t_eqm(t3,rho3)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_3,
        eta_pa_s,
    ...
    let eta_pa_s = mu_rho_t_eqm(t4,rho4)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_4,
        eta_pa_s,
...
pub fn psi_1_viscosity_p_t_test(){
    ...
    let eta_pa_s = mu_tp_eqm_single_phase(t1, p1)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_1,
        eta_pa_s,
    ...
    let eta_pa_s = mu_tp_eqm_single_phase(t2, p2)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_2,
        eta_pa_s,
    ...
    let eta_pa_s = mu_tp_eqm_single_phase(t3, p3)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_3,
        eta_pa_s,
    ...
    let eta_pa_s = mu_tp_eqm_single_phase(t4, p4)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_4,
        eta_pa_s,
...
pub fn psi_1_viscosity_p_t_x_test(){
    ...
    let eta_pa_s = mu_tp_eqm_two_phase(t1, p1, x)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_1,
        eta_pa_s,
    ...
    let eta_pa_s = mu_tp_eqm_two_phase(t2, p2,x)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_2,
        eta_pa_s,
    ...
    let eta_pa_s = mu_tp_eqm_two_phase(t3, p3,x)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_3,
        eta_pa_s,
    ...
    let eta_pa_s = mu_tp_eqm_two_phase(t4, p4,x)
        .get::<pascal_second>();
    approx::assert_relative_eq!(
        eta_pa_s_4,
        eta_pa_s,
